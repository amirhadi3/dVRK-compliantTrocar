...
class psm_random_move_fast(object):
    ...
    def home(self):
        ...
        self.home_pos = [3.4/180*math.pi,1.1/180*math.pi,0.0535,0,0,0]
        axis = 0
...
if __name__ == "__main__":
	...
	motion_rng = [[-0.02,0.02],[-0.02,0.03],[-0.02,0.02],[-math.pi/6,math.pi/6],[-math.pi/6,math.pi/6],[-math.pi/6,math.pi/6]]
	...
	for i in range(1):
		...
		zaber_axis = 0.0535-p.z[index]#+traj[index,2]/2
